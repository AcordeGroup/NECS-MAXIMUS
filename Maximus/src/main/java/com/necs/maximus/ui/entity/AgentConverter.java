 ...
 */
@Named(value = "agentConverter")
@ManagedBean
public class AgentConverter implements Converter {

    @Inject
    private AgentFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Agent) {
            ...
            return getStringKey(o.getIdAgent());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Agent.class.getName()});
            return null;
        }
    }
